...
class Conv12(Pruneable):

    def __init__(self, device="cuda", output_dim=2, input_dim=(1,), **kwargs):
        super(Conv12, self).__init__(device=device, output_dim=output_dim, input_dim=input_dim, **kwargs)
        ...
        self.conv = nn.Sequential(
            ...
            self.Conv2d(in_channels=channels, out_channels=128, kernel_size=3, padding=1, bias=True, gain=gain),
            ...
            self.Conv2d(in_channels=256, out_channels=512, kernel_size=3, padding=1, bias=True, gain=gain),
            nn.BatchNorm2d(512, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True),
            nn.LeakyReLU(leak),
            self.Conv2d(in_channels=512, out_channels=512, kernel_size=3, padding=1, bias=True, gain=gain),
            nn.BatchNorm2d(512, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True),
            nn.LeakyReLU(leak),
            # nn.MaxPool2d(kernel_size=2),
        ...
        self.fc = nn.Sequential(
            ...
            self.Linear(512*PROD_MIDDLE_POOL, 512, bias=True, gain=gain),
            nn.BatchNorm1d(512, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True),
            nn.LeakyReLU(leak),

            nn.Dropout(p=0.3, inplace=False),
            self.Linear(512, 512, bias=True, gain=gain),
            nn.BatchNorm1d(512, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True),
            nn.LeakyReLU(leak),

            nn.Dropout(p=0.3, inplace=False),
            self.Linear(512, output_dim, bias=True),
