from models.criterions.CROPStructuredRes import CROPStructuredRes


class CROPStructuredDuringRes(CROPStructuredRes):
    """
    ...
    def __init__(self, *args, limit=0.0, start=0.5, steps=5, **kwargs):
        super(CROPStructuredDuringRes, self).__init__(*args, **kwargs)
        if limit < 0.5:
